...
class noLabDataset(Dataset):
    def __init__(self,train_dataset, dataloader, model, device, thres=0.85):
...
def get_semi_loader(train_loader, dataloader,model, device, thres):
    semi_set = noLabDataset(train_loader.dataset, dataloader, model, device, thres)
